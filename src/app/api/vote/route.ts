...
export async function POST(request: NextRequest) {
    try {
        const { votedById, voteStatus, type, typeId } = await request.json();
         ...
         //list - document 
        //query filters that must be included in the results
        //db is the identifier of the database
        //voteCollection is the collection within the 
        // database from which documents will be listed.
